...
public class DecoderTest {
	...
	public void allLinesReadTest() {
		...
		try {
			Hashtable<String, String>[] data = dec.getData("ExampleInputData/server_log.csv");
			assertEquals(23865, data.length);
			
			data = dec.getData("ExampleInputData/impression_log.csv");
			assertEquals(486095, data.length);
			
			data = dec.getData("ExampleInputData/click_log.csv");
